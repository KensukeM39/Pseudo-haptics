...
After pressing the Play button,
  Space key: You can move the ping-pong racket.
  Enter key: You can switch the object.
             There are three objects: a ping pong ball, a balloon, and an iron ball.
